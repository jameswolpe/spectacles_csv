...
class ContentError(ValidationError):
    def __init__(
        ...
        is_merge: Optional[str] = None,
        is_filter: Optional[str] = None,
        is_scheduled: Optional[str] = None,
        model_name_list: Optional[str] = None,
        explore_name_list: Optional[str] = None,
        error_message_list: Optional[str] = None,
